...
import { Review } from '@sharedTypes/types/application.types';
import { User } from '@sharedTypes/types/user.types';
import { formatRating, formatDate } from '@utils/tableFormatters';
...
/**
 * Popover component that displays detailed review information.
 * Shows reviewer names, ratings, and comments for a specific application.
 */
